...
import unittest
from nlp.test_edit_stock_commands import TestEditStockCommands
from nlp.mixed_entity_extraction import extract_mixed_edit_stock_details, normalize_mixed_command
...
if __name__ == "__main__":
    debug_test_cases()
    # Create a test suite with the TestEditStockCommands class
    test_suite = unittest.TestLoader().loadTestsFromTestCase(TestEditStockCommands)
